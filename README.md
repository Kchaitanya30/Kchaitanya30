...
| GeoAI & LLM Experiments | Exploratory use of LLMs for geospatial analysis workflows | Ongoing |
 [Spatial analysis on Baltimore Vacant Properties](./Final_Project/) | Spatial analysis of vacant properties and related spatial patterns in Baltimore | In progress |
...
- ArcGIS Pro, QGIS  
- PostgreSQL / PostGIS  
- raster, sf, terra, tidyverse  
- netCDF / HDF satellite data  
- Reproducible workflows (Quarto, R Markdown)
